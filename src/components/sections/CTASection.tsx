...
export default function CTASection({ heading1, heading2, body, buttons = [] }: Readonly<CTASectionProps>) {
  ...
  return (
    <section className="w-full max-w-272.5 h-69.5 mx-auto mb-24 mt-10 px-8 py-12 lg:px-14 rounded-sm bg-primary">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
        <div className="text-center mt-5 lg:text-left lg:max-w-xl">
        ...
        <div className="flex flex-col gap-6 w-full sm:w-auto lg:w-57.25">
          {buttons.map((btn) => (
